<template>
    <fragment>
        <c-hero-full class="illustration-section-02" />
        <c-team />
        ...
        <c-generic-section top-divider>
            <div class="container-xs">
                ...
                <c-modal id="demo-modal" :active.sync="demoModalActive">
                    <div class="center-content">
                        <h3 class="mt-32 mb-12">Join our newsletter</h3>
                        <p class="text-sm">
        ...
        <div class="spacer-64 spacer-24-mobile has-bg-color"></div>
        <div class="spacer-24 has-bg-color"></div>
